...
// import
// br.fiap.projeto.contexto.comanda.adapter.controller.rest.dto.ComandaDTO;
// import br.fiap.projeto.contexto.comanda.entity.enums.StatusComanda;
// import
// br.fiap.projeto.contexto.pagamento.adapter.controller.rest.request.PagamentoAEnviarAoGatewayDTORequest;
// import
// br.fiap.projeto.contexto.pagamento.adapter.controller.rest.request.PagamentoStatusDTORequest;
// import
// br.fiap.projeto.contexto.pagamento.adapter.controller.rest.request.PedidoAPagarDTORequest;
// import
// br.fiap.projeto.contexto.pagamento.adapter.controller.rest.response.PagamentoDTOResponse;
// import br.fiap.projeto.contexto.pagamento.entity.Pagamento;
// import br.fiap.projeto.contexto.pagamento.entity.enums.StatusPagamento;
// import
// br.fiap.projeto.contexto.pedido.adapter.controller.rest.response.PedidoDTO;
// import br.fiap.projeto.contexto.pedido.entity.enums.StatusPedido;
// import
// br.fiap.projeto.contexto.produto.adapter.controller.rest.response.ProdutoDTOResponse;
...
// // Cria pedido
// pedido = restTemplate.postForEntity(createUriWithPort("/pedidos"), null,
...
// produtos = restTemplate.exchange(createUriWithPort("/produtos"),
// HttpMethod.GET, null, new
// ParameterizedTypeReference<List<ProdutoDTOResponse>>(){}).getBody();

// assertFalse(CollectionUtils.isEmpty(produtos));

// // Adiciona os produtos no pedido
// for (ProdutoDTOResponse p : produtos) {
// pedido = restTemplate.exchange(createUriWithPort("/pedidos/" + codigoPedido +
// "/adicionar-produto/" + p.getCodigo()), HttpMethod.POST, null,
// PedidoDTO.class).getBody();
// }
// assertNotNull(pedido);
...
// pedido = restTemplate.exchange(createUriWithPort("/pedidos/" + codigoPedido +
// "/pagar"), HttpMethod.PUT, null, PedidoDTO.class).getBody();
// assertNotNull(pedido);
...
// pedidoAPagar = new PedidoAPagarDTORequest(codigoPedido,
// pedido.getValorTotal());
// httpEntity = new HttpEntity<>(pedidoAPagar);
// restTemplate.exchange(createUriWithPort("/pagamento/processa/novo-pagamento"),
// HttpMethod.POST, httpEntity, Void.class);

// // Recupera pedido por código para verificação de status -
// /por-status/{status}
// // Valida se o estado alterou para PENDING
// pagamentoPedido =
// restTemplate.exchange(createUriWithPort("/pagamento/busca/por-codigo-pedido/"
// + codigoPedido), HttpMethod.GET, null, PagamentoDTOResponse.class).getBody();
...
// // Envia para o gateway de pagamento - status é alterado para
// em_processamento - /pagamento/gateway/gateway-de-pagamento
// pagamentoPendente = new PagamentoAEnviarAoGatewayDTORequest(new
// Pagamento(codigoPedido, pagamentoPedido.getValorTotal(),
// StatusPagamento.IN_PROCESS, Calendar.getInstance().getTime()));
// httpEntity = new HttpEntity<>(pagamentoPendente);
// restTemplate.postForObject(createUriWithPort("/pagamento/gateway/gateway-de-pagamento"),
...
// pagamentoStatusDTO = new PagamentoStatusDTORequest(codigoPedido,
// StatusPagamento.REJECTED);
// httpEntity = new HttpEntity<>(pagamentoStatusDTO);
// restTemplate.patchForObject(createUriWithPort("/pagamento/retorno-gateway/atualiza-status"),
// httpEntity, Void.class);

// // Recupera pedido por código para verificação de status -
// /por-status/{status}
// // Valida se o estado alterou para rejected
// ParameterizedTypeReference<List<PagamentoDTOResponse>> type = new
// ParameterizedTypeReference<List<PagamentoDTOResponse>>() {};
// ResponseEntity<List<PagamentoDTOResponse>> response =
// restTemplate.exchange(createUriWithPort("/pagamento/busca/por-status/" +
// StatusPagamento.REJECTED), HttpMethod.GET, null, type);
...
// pedido = restTemplate.exchange(createUriWithPort("/pedidos/" + codigoPedido +
// "/atualizar-pagamento"), HttpMethod.PATCH, null, PedidoDTO.class).getBody();
// assertNotNull(pedido);
// assertEquals(StatusPedido.PAGO, pedido.getStatus());

// // Pedido cria a comanda => @PatchMapping("/{codigo}/enviar-comanda")
// pedido = restTemplate.exchange(createUriWithPort("/pedidos/" + codigoPedido +
// "/enviar-comanda"), HttpMethod.PATCH, null, PedidoDTO.class).getBody();
// assertNotNull(pedido);
// assertEquals(StatusPedido.EM_PREPARACAO, pedido.getStatus());

// // Busca comandas pendentes => @GetMapping("/comandas/busca-pendentes")
// comandasPendentes =
// restTemplate.exchange(createUriWithPort("/comandas/busca-recebido"),
// HttpMethod.GET, null, new
// ParameterizedTypeReference<List<ComandaDTO>>(){}).getBody();
...
// comanda = restTemplate.exchange(createUriWithPort("/comandas/" +
// comanda.getCodigoComanda() + "/preparar"), HttpMethod.PATCH, null,
// ComandaDTO.class).getBody();
// assertNotNull(comanda);
...
// comanda = restTemplate.exchange(createUriWithPort("/comandas/" +
// comanda.getCodigoComanda() + "/finalizar"), HttpMethod.PATCH, null,
// ComandaDTO.class).getBody();
// assertNotNull(comanda);
...
// pedido = restTemplate.exchange(createUriWithPort("/pedidos/" + codigoPedido +
// "/entregar"), HttpMethod.PUT, null, PedidoDTO.class).getBody();
// assertNotNull(pedido);
...
// String sUrl = String.format("http:////localhost:%d/%s", SERVER_PORT,
// s).replace("//", "/");
