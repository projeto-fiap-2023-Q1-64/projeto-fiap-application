...
// pedido = restTemplate
// .exchange(createUriWithPort("/pedidos/" + codigoPedido +
// "/adicionar-produto/"
// + p.getCodigo()),
...
// .exchange(createUriWithPort("/pagamento/busca/por-codigo-pedido/" +
// codigoPedido),
...
// .exchange(createUriWithPort("/comandas/busca-recebido"), HttpMethod.GET,
// null,
...
// .exchange(createUriWithPort("/comandas/" + comanda.getCodigoComanda() +
// "/preparar"),
...
// pedido = restTemplate
// .exchange(createUriWithPort("/pedidos/" + codigoPedido + "/entregar"),
// HttpMethod.PUT,
