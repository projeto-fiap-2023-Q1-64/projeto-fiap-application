...
// @Component
// @Primary
public class BuscaPorComandaGatewayAdapter implements IBuscaPorComandaGatewayAdapter {
    ...
    @Override
    public Comanda buscaPorComanda(UUID codigoComanda) throws ExceptionMessage {
